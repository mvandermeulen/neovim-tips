...
\href{https://github.com/saxon1964/neovim-tips}{saxon1964/neovim-tips}. The plugin brings together hundreds of helpful tips, tricks, and shortcuts, all available through a custom picker. It's easy to expand with your own entries, so the collection grows with you and your workflow.

\begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=\textwidth]{Structure/Images/s1.png}}
  \vspace{-2em}
...
\begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=\textwidth]{Structure/Images/s2.png}}
  \vspace{-2em}
